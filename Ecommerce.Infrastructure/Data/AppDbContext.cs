    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<LocalUser>().HasData(
                new LocalUser { Id = 1, Email = "ahmad@gmail.com", Name = "Ahmed Haggag", UserName = "Haggag281", Password = "password123", Role = "Admin" },
                new LocalUser { Id = 2, Email = "Tarek12@gmail.com", Name = "Tarek Sharim", UserName = "Tarek777", Password = "password456", Role = "User" }
            );
